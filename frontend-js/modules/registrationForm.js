...
export default class RegistrationForm {
  ...
  passwordImmediately(){
    if(this.password.value.length > 50){
      this.showValidationError(this.password, "Password cannot excced 50 characters.");
    }
  ...
  passwordAfterDelay() {
    if(this.password.value.length < 10) {
      this.showValidationError(this.password, "The password must be longer then 10 digit.");
    }
  }
